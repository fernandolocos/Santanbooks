...
public class Responder implements IResponder
{
	...
	public boolean finalAnswer(String answer)
	{
		...
		jaPerguntou = true;
		//System.out.println("Animal Responder: " + this.animal);
		//System.out.println("Animal Enquirer: " + answer);
		System.out.println("Animal respondido: " + answer);
		...
		//System.out.println("----------------------");
		System.out.println("Perguntas repetidas:");
