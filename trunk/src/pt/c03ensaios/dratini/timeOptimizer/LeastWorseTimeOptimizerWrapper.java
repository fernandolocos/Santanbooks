...
@Component(id = "<http://purl.org/dcc/pt.c03ensaios.dratini.timeOptimizer.LeastWorseTimeOptimizerWrapper>", 
		provides = { "<http://purl.org/dcc/pt.c03ensaios.optimizers.IOptimizer>"})


public class LeastWorseTimeOptimizerWrapper extends ComponentBase implements IOptimizer  {
	private LeastWorseTimeOptimizer opt;
	
	public LeastWorseTimeOptimizerWrapper() {
		...
		try {
			...
			opt = factory.createInstance("<http://purl.org/dcc/pt.c03ensaios.dratini.timeOptimizer.LeastWorseTimeOptimizer>");
			opt.connect(para);
