...
public class AnimalFile extends ComponentBase implements IAnimalFile {
	 ...
	 */
	public boolean availableProperties(IAnimalsDatabase animals){
		boolean available = true;
		
		for( IAnimalData aux: animals.getAnimais())
	...
	private boolean compareAnimals(IAnimalData other){
		...
		for(String question: questions){
			aux = (Hashtable<String, String>)this.getAnimal().clone();
			if(other.getResposta(question).equals(aux.get(question))){
				aux.remove(question);
