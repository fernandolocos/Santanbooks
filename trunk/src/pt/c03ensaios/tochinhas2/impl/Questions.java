...
@Component(id="<http://purl.org/dcc/pt.c03ensaios.tochinhas2.impl.Questions>",
		   provides={"<http://purl.org/dcc/pt.c03ensaios.tochinhas2.impl.IQuestions>"},
           requires={"<http://purl.org/dcc/pt.c03ensaios.linnaeus.IAnimalsDatabase>"})
public class Questions extends ComponentBase implements IQuestions, IRequires<IAnimalsDatabase> {
	...
	public void connect(IAnimalsDatabase base) {
		...
		// If no database is provided, uses a default database.
		if (this.database == null) {
			this.database = new AnimalsDatabase();
		}
	}
}