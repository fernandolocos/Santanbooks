...
/**
 * Decision tree with elements as leafs and characteristics as inner nodes that minimizes entropy.
 * 
 * @author Kamila Galvani
 */
@Component(id = "<http://purl.org/dcc/pt.c03ensaios.dratini.simpleDecisionTree.EntropyDecisionTree>",
        provides = {"<http://purl.org/dcc/pt.c03ensaios.dratini.simpleDecisionTree.IDecisionTree>"})

public class EntropyDecisionTree extends Enquirer implements IEnquirer, IEnquirerSupports, IDecisionTree {
